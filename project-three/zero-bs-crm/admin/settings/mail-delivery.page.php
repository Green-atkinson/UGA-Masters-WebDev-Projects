    ...
    <script type="text/javascript">
        ...
        var zeroBSCRMJS_lang = {
            ...
            settingsValidateGMAIL : '<?php
                ##WLREMOVE
                zeroBSCRM_slashOut(__('GMail sometimes requires further steps to complete.',"zero-bs-crm") . ' <a href="' . $zbs->urls['kbgmailsetup'] . '" target="_blank">' . __('Read the Gmail Setup guide.','zero-bs-crm')) . '</a>';
                ?></a><?php
                ##/WLREMOVE
