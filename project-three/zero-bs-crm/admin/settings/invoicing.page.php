...
<div id="sbA">
    ...
    <form method="post">
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_invtax"><?php _e('Show tax on invoices',"zero-bs-crm"); ?>:</label><br /><?php _e('Tick if you need to charge tax',"zero-bs-crm"); ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_invdis"><?php _e('Show discount on invoices',"zero-bs-crm"); ?>:</label><br /><?php _e('Tick if you want to add discounts',"zero-bs-crm"); ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_invpandp"><?php _e('Show P&P on invoices',"zero-bs-crm"); ?> (<?php _e('Shipping',"zero-bs-crm"); ?>):</label><br /><?php _e('Tick if you want to add postage and packaging',"zero-bs-crm"); ?></td>
