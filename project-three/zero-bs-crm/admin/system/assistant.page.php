  ...
  // all assumes admin.
        ...
        $job_list = array(
            ...
            'complete_welcome_tour' => array(
                ...
                'desc_complete'   => __( 'Good start, looks like you have completed the welcome tour.', 'zero-bs-crm' ),
                'help_url'        => zeroBSCRM_getAdminURL($zbs->slugs['dash']) . '&zbs-welcome-tour=1',
                'help_txt'        => __( 'Start tour', 'zero-bs-crm' ),
                'state'           => 1, // for now default
            ...
            'first_contact' => array(
                ...
                'help_url'        => $zbs->urls['kbfirstcontact'],
                'state'           => ( zeroBS_customerCount() > 0 ? 1 : 0 ),
        ...
        $job_list['try_invoicing'] = array(
            ...
            'help_url'        => $zbs->urls['kbactivatecoreext'],
            'state'           => ( zeroBSCRM_getSetting('feat_invs') > 0 ? 1 : 0 ),
        ...
        if ( zeroBSCRM_getSetting('feat_invs') > 0 ){
            ...
            $job_list['first_invoice'] = array(
                ...
                'help_url'        => $zbs->urls['kbinvoicebuilder'],
                'state'           => ( zeroBS_invCount() > 0 ? 1 : 0 ),
        ...
        $job_list['add_team'] = array(
            ...
            'help_url'        => $zbs->urls['kbteam'],
            'state'           => ( count( zeroBSCRM_crm_users_list() ) > 0 ? 1 : 0 ),
        ...
        $job_list['add_extension'] = array(
            ...
            'help_url'        => $zbs->urls['home'],
            'help_txt'        => __( 'Get Extensions', 'zero-bs-crm' ),
            'state'           => ( count( zeroBSCRM_activeInstalledProExt() ) > 0 ? 1 : 0 ),
        ...
        $job_list['stay_up_to_date'] = array(
            ...
            'help_url'        => admin_url('update-core.php'),
            'help_txt'        => __( 'View Updates', 'zero-bs-crm' ),
            'state'           => ( $has_update ? 0 : 1 ),
...
function jpcrm_render_system_assistant_job( $job = array() ){
  ...
  if ( !isset( $job['help_txt'] ) ){

      $job['help_txt'] = __( 'Read Guide', 'zero-bs-crm' );

  }

  ?><div class="jpcrm-assistant-job jpcrm-assistant-state-<?php echo $job['state']; ?>">
      <div class="ui grid">
        ...
        <div class="fourteen wide column">
          ...
          <p class="job-help"><a href="<?php echo $job['help_url']; ?>" target="_blank" class="ui button"><?php echo $job['help_txt']; ?></a></p>
        </div>
      </div>
  </div><?php
