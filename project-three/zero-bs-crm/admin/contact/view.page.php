...
function jpcrm_render_contact_view_page( $id = -1 ){
  ...
  if (!empty($id) && $id > 0){
      ...
      $zbsSocials = $zbsSocialsProper; unset($zbsSocialsProper);
              ...
              $contact_email = '';
              if ( isset( $zbsCustomer['email'] ) ) {
                  $contact_email = $zbsCustomer['email'];
              }
              ...
              $avatar = '';
              if ( $avatarMode !== "3" ) {
                  $avatar = zeroBS_customerAvatarHTML( $id, $zbsCustomer, 100, 'ui small image centered' );
              }

              // check flags (atm this is just 'do-not-email' 2.90+)
              $contactFlags = array();
              if ( $zbs->DAL->contacts->getContactDoNotMail( $id ) ) {
                  $contactFlags[] = 'do-not-email';
              }
                      ...
                      <div class="ui bottom attached <?php if ($activeTab == 'quotes') echo 'active '; ?>tab segment" data-tab="quotes">
                        <table class="ui celled table unstackable">
                          ...
                          <tbody>
                            ...
                            $new_quote_url = zbsLink('create',-1,ZBS_TYPE_QUOTE).'&zbsprefillcust='.$zbsCustomer['id'];
                      ...
                      <div class="ui bottom attached <?php if ($activeTab == 'invoices') echo 'active '; ?>tab segment" data-tab="invoices">
                        <table class="ui celled table unstackable">
                          ...
                          <tbody>
                            ...
                            $new_invoice_url = zbsLink('create',-1,ZBS_TYPE_INVOICE).'&zbsprefillcust='.$zbsCustomer['id'];
                      ...
                      <div class="ui bottom attached <?php if ($activeTab == 'transactions') echo 'active '; ?>tab segment" data-tab="transactions">
                        ...
                        <table class="ui celled table unstackable">
                          ...
                          <tbody>
                            ...
                            $new_transaction_url = zbsLink('create',-1,ZBS_TYPE_TRANSACTION).'&zbsprefillcust='.$zbsCustomer['id'];
                      ...
                      <div class="ui bottom attached <?php if ($activeTab == 'tasks') echo 'active '; ?>tab segment" data-tab="tasks">
                        <table class="ui celled table unstackable">
                          ...
                          <tbody>
                            ...
                            $new_task_url = zbsLink('create',-1,ZBS_TYPE_EVENT).'&zbsprefillcust='.$zbsCustomer['id'];
                        ...
                        <?php if (count($zbsCustomer['tasks']) > 0) : ?>
                          <div style="text-align: right;">
